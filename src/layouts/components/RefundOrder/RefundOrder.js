      ...
      <div className="container">
        <div className="main pt-4 pb-4">
          <div className="row">
            ...
            {orderID === undefined || orderdata === undefined ? (
              <LoadingPage />
            ) : (
