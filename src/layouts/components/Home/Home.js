			...
			<div className="container">
				<div className={`${styles["main"]} pt-4 pb-4`}>
					<div className={`${styles["menu-category"]} pt-4 pb-4`}>
						<div className="row">
							<div className="col col-lg-2">
								<div
									className={`${styles["menu-category-item"]} ${styles["menu-category-list"]}`}
								>
							...
							<div className="col pl-3">
								<div
									className={`${styles["menu-category-item"]}`}
								>
									<a
										href="/products"
										className={`${styles["menu-category-item-link"]}`}
									>
										<div
										...
										></div>
										<div
											className={`${styles["menu-category-content"]}`}
										>
											<div>
					...
					<div className={`${styles["deals-offers"]} pt-4 pb-4`}>
						<div className="row">
							<div
								className={`col-2 ${styles["deals-offers-item"]} p-3`}
							>
								<div
									className={`${styles["deals-offers-item-title"]}`}
								>
									<h5>Deals and offers</h5>
									<span>Hygiene equipments</span>
								</div>
								<div
									className={`${styles["deals-offers-item-timeout"]} mt-2`}
								>
									<div>
										<span>04</span>
										<span>Days</span>
							...
							>
								<a href="/product">
									<div
										className={`${styles["deals-offers-item-img"]}`}
									>
										<div
									...
									<div
										className={`${styles["deals-offers-item-content"]}`}
									>
										<div>
								...
								<a href="/product">
									...
									>
										...
										>
											...
											<div
												className={`${styles["name"]} overflow-hidden`}
											>
