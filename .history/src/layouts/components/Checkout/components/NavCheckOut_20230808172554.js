                  ...
                  <div style={{ display: "flex" }}>
                    <div>
                      <input
                        ...
                        value={addressData.stt}
                        checked={index === chooseTemp}
                        onChange={() => {
                          chooseTemp = index;
                          // setChoose(addressData);
                          console.log("click i:", chooseTemp);
                        }}
                      />
                    </div>
                    <div style={{ marginLeft: "10px", width: "100%" }}>
                      <label for={addressData.stt} style={{ width: "100%" }}>
                        {addressData.SONHA_DUONG}
                        <br />
                        {addressData.TEN_PHUONG}, {addressData.TEN_THANHPHO},{" "}
                        {addressData.TEN_TINH}
                      </label>
                    </div>
                  </div>
                  <div className="line mt-2 mb-2"></div>
        ...
        <>
          ...
          <div className="bg-w border rounded p-4 pr-3 pl-3">
            <div>
              ...
              <button
                onClick={() => {
                  const dataModal = ModalAddress(choose.index);
