...
export const NavCheckOut = ({ Price, handlePayment }) => {
  ...
  const [chooseTemp, setChooseTemp] = useState(choose.stt);
  const Modal = () => {
    return (
      <>
                  ...
                  <div style={{ display: "flex" }}>
                    <div>
                      <input
                        ...
                        checked={
                          address[index].stt === choose.stt ? "checked" : ""
                        }
                        onClick={setChooseTemp(address[index].stt)}
                      />
                    </div>
